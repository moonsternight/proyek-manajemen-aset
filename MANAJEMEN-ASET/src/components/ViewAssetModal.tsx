...
const ViewAssetModal: React.FC<ViewAssetModalProps> = ({
  ...
  useEffect(() => {
    const fetchHistory = async () => {
      if (isOpen && activeTab === "history" && role === "admin") {
        try {
    ...
    fetchHistory();
  }, [isOpen, activeTab, asset.id, role]);
          ...
          <div style={tabContainerStyle}>
            ...
            <button
              ...
              style={{
                ...tabButtonStyle,
                backgroundColor:
                  activeTab === "history" ? "#E2E8F0" : "#F8FAFC",
            ...
            {[
              ...
              [
                ...
                <span
                  style={{
                    backgroundColor:
                      asset.status === "Terpasang" ? "#F97316" : "#22C55E",
                    color: "white",
                    fontSize: "0.75rem",
